...
height = input() #
print("How much do you weigh?", end=' ') # print("How much do you weigh?", end=' '
weight = input()
...
txt = open(filename) #!!! txt = open(filenme)

print(f"Here's your file {filename}:") # print("Here's your file {filename}:")
print(txt.read()) # print(tx.read())
...
print(txt_again.read()) # print(txt_again_read())
...
start_point = 10000
beans, jars, crates = secret_formula(start_point) # beans, jars = secret_formula(start_point)
...
formula = secret_formula(start_point) # formula = secret_formula(startpoint)
